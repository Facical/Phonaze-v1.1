...
extension ScrollViewGame {
    ...
    private func showGoalSelectionAlert() {
        ...
        let alert = UIAlertController(title: "게임 점수 선택",
                                      message: "Pick total points to finish",
                                      preferredStyle: .alert)
        
        // 세 가지 액션
        let fiveAction = UIAlertAction(title: "5점", style: .default) { _ in
            scoreGoal = 5
        }
        let tenAction = UIAlertAction(title: "10점", style: .default) { _ in
            scoreGoal = 10
        }
        let fifteenAction = UIAlertAction(title: "15점", style: .default) { _ in
            scoreGoal = 15
        }
